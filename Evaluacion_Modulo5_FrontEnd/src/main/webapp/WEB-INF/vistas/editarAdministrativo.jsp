...
<body>
	...
	<main class="main">
		...
		<h1 class="titulo-principal">Editar Administrativo</h1>

		<div class="container formulario">
		
			<form action="modificar" method="post" id="formAdministrativo" modelAttribute="formAdministrativo">
			...
			<!-- Datos de acceso y rol  -->
                ...
                <div id="administrativo" >
                	...
                	<div class="form-dato">
	                    ...
	                    <input type="number" id="idAdministrativo" name="idAdministrativo" class="form-campo" value="${editar.getIdAdministrativo()}">
	                </div>
                	
	                <div class="form-dato">
	                    <label for="adCorreo" class="form-label">Correo: </label>
	                    <input type="text" id="adCorreo" name="adCorreo" class="form-campo" value="${editar.getAdCorreo()}">
	                </div>
	                
	                <div class="form-dato">
	                    <label for="adArea" class="form-label">Area*: </label>
	                    <input type="text" id="adArea" name="adArea" class="form-campo" value="${editar.getAdArea()}">
	                </div>
                ...
                <div class="form-dato">
                    ...
                    <input class="submit" type="submit" value="Editar Administrativo">
                </div>
                <br>
            </form>
