...
<body>
	...
	<main class="main">
		...
		<h1 class="titulo-principal">Editar Cliente</h1>

		<div class="container formulario">
		
			<form action="modificar" method="post" id="formCliente" modelAttribute="formCliente">
			...
			<!-- Datos de acceso y rol  -->
				...
				<div id="cliente" >
	                ...
	                <div class="form-dato">
	                    ...
	                    <input type="number" id="rutCliente" name="rutCliente" class="form-campo" value="${editar.getRutCliente()}">
	                </div>
	                
	                 <div class="form-dato">
	                    <label for="cliTelefono" class="form-label">Telefono*: </label>
	                    <input type="text" id="cliTelefono" name="cliTelefono" class="form-campo" value="${editar.getCliTelefono()}">
	                </div>
	                
	                <div class="form-dato">
	                    <label for="cliAfp" class="form-label">Afp: </label>
	                    <input type="text" id="cliAfp" name="cliAfp" class="form-campo" value="${editar.getCliAfp()}">
	                </div>
	                ...
	                <div class="form-dato">
	                    ...
	                    <input type="text" id="cliDireccion" name="cliDireccion" class="form-campo" value="${editar.getCliDireccion()}">
	                </div>
	                
	                 <div class="form-dato">
	                    <label for="cliComuna" class="form-label">Comuna*: </label>
	                    <input type="text" id="cliComuna" name="cliComuna" class="form-campo" value="${editar.getCliComuna()}">
	                </div> 
	                
	                <div class="form-dato">
	                    <label for="cliEdad" class="form-label">Edad*: </label>
	                    <input type="number" id="cliEdad" name="cliEdad" class="form-campo" value="${editar.getCliEdad()}">
	                </div>  
